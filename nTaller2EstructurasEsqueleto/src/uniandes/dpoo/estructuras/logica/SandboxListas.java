...
public class SandboxListas
{
    ...
    {
    	//reiniciamos el valor completamente
        listaEnteros = new ArrayList<Integer>( );
        //copiamos todos los valores usando for 
    	int i = 0;
    ...
    {
    	//Reiniciamos completamente la variable
        listaCadenas = new LinkedList<String>( );
    ...
    public boolean compararArregloEnteros( int[] otroArreglo )
    {
    	...
    	if (tamanio == otroArreglo.length){ //si tienen el mismo tamaño, nos vamos  a los números
    		//o se nos acaban los números o dejan de ser iguales
    		while(i<tamanio && iguales == true) {
    	...
    	}else { //si tienen tamaño distinto, de una deben ser distintos
    		iguales = false;
    	}	
        return iguales;
    }
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo )
    {
        ...
        listaEnteros = new ArrayList<Integer>( );
        //Agregamos la cantidad de numeros deseados
    	for(int i =0; i<cantidad;i++) {
			listaEnteros.add((int)(Math.random() * (maximo - minimo + 1)) + minimo);//Formula para hallar un entero entre dos numeros 			
