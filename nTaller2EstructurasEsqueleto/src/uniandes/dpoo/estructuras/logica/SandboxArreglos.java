...
public class SandboxArreglos
{
    ...
    public int[] getCopiaEnteros( )
    {
    	...
    	int[] nuevo_arreglo = new int[tamanio];
    	for(int i = 0; i<tamanio;i++) {
    		nuevo_arreglo[i] = arregloEnteros[i];
    	}
        return nuevo_arreglo; //Primer cambio
    }
    ...
    public String[] getCopiaCadenas( )
    {
    	...
    	String[] nuevo_arreglo = new String[tamanio];
    	for(int i = 0; i<tamanio; i++) {
    		nuevo_arreglo[i] = arregloCadenas[i];
    	}
        return nuevo_arreglo; //Segundo cambio
    }
    ...
    public void insertarEntero( int entero, int posicion )
    {
    	...
    	while(i<tamanio_original) {
    		...
    		} else if (i == posicion || i>posicion) { //nos saltamos cuando es igual
    			nueva_lista[i+1] = arregloEnteros[i];
    		}
    		i++;
    	}
    	nueva_lista[posicion]=entero; //como antes lo saltamos, lo agregamos ahora
    ...
    public void eliminarEnteroPorPosicion( int posicion )
    {
    	...
    	if (0 <= posicion && posicion < tamanio){ //doble comparacion
    	...
    	//Recorremos todas las posiciones de la lista de la nueva 
    	int i = 0;
    	while(i < (tamanio-1)) {
    		if(i<posicion) {
    			nueva_lista[i] = arregloEnteros[i];
    			...
    			nueva_lista[i] = arregloEnteros[i+1];
    		}
    		i++;
    	}
    	arregloEnteros = nueva_lista;
    ...
    public void volverPositivos( )
    {
    	...
    	while(i<tamanio) {
    		...
    		i++; //si no lo ponemos tenemos un ciclo infinito
    	}
    ...
    public int[] buscarEntero( int valor )
    {
    	...
    	for(int i = 0; i<tamanio; i++) {
    		if (valor == arregloEnteros[i]) { //Si algun elemento coincide con el valor
    			nueva_lista[contador] = i; //Agregamos el indice de contador que coincide
